    ...
    <>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <TextInput
            placeholder="Name"
            style={[styles.name, errors.name && styles.inputError]}
            value={name}
            onChangeText={(text) => {
              setName(text);
          ...
          <Text style={styles.lasttext}>
            ...
            <Text style={styles.termstext} onPress={termsAndServices}>
              Terms of Services
            </Text>
            {" and "}
            <Text style={styles.privacytext} onPress={privacyAndPolicy}>
              Privacy Policy
            </Text>
          </Text>
        </View>
